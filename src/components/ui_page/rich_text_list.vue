    ...
    <div>
      ...
      <el-table style="margin-top:15px;width: 100%" :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" >
          <template slot-scope="scope">
            <el-dropdown size="mini" split-button type="default" trigger="click" @click="previewArticle('article',scope.row.sunwouId)">
              查看
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item><div style="width:70px;text-align:Center" @click="previewArticle('article_update',scope.row.sunwouId)">修改</div></el-dropdown-item>
